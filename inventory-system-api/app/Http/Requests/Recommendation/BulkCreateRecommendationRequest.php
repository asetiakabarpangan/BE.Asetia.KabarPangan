...
class BulkCreateRecommendationRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'job_profile_ids'   => ['required', 'array', 'min:1'],
    ...
    public function messages(): array
    {
        return [
            ...
            'job_profile_ids.required' => 'Daftar profil pekerjaan wajib diisi.',
